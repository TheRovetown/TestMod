...
public class SpringpositivexItem extends Item
{

	public SpringpositivexItem(Properties properties)
	{
		super(properties);
	}
	...
	public void addInformation(ItemStack stack, World worldIn, List<ITextComponent> tooltip, ITooltipFlag flagIn)
	{
		...
		{
			tooltip.add(new StringTextComponent("Fly to positive x values!"));
